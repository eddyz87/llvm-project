...
entry:
  call bpf_fastcall void @bar()
  %cmp = icmp sgt i64 %k, 42
  br i1 %cmp, label %if.then, label %if.else

if.then:
  call bpf_fastcall void @buz(i64 noundef %i, i64 noundef 1)
  br label %if.end

if.else:
  call bpf_fastcall void @buz(i64 noundef 1, i64 noundef %j)
  br label %if.end
...
declare dso_local bpf_fastcall void @bar()
declare dso_local bpf_fastcall void @buz(i64 noundef, i64 noundef)
