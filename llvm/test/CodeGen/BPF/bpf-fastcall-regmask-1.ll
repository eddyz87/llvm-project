...
declare dso_local bpf_fastcall void @bar1()
...
entry:
  tail call bpf_fastcall void @bar1()
...
declare dso_local bpf_fastcall i64 @bar2()
...
entry:
  tail call bpf_fastcall i64 @bar2()
...
declare dso_local bpf_fastcall void @bar3(i64)
...
entry:
  tail call bpf_fastcall void @bar3(i64 noundef %i)
...
declare dso_local bpf_fastcall i64 @bar4(i64 noundef, i64 noundef)
...
entry:
  tail call bpf_fastcall i64 @bar4(i64 noundef %i, i64 noundef %j)
