...
;   }
; Compilation flag:
;   clang -Xclang -fexperimental-assignment-tracking=disabled \
;         -target bpf -O2 -g -S -emit-llvm test.c
...
entry:
  ...
  tail call void @llvm.dbg.declare(metadata ptr %v, metadata !11, metadata !DIExpression()), !dbg !24
...
declare !dbg !27 dso_local void @func(ptr noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "some-file.c", directory: "/some/_dir", checksumkind: CSK_MD5, checksum: "7735a89e98603fee29d352a8e9db5acb")
