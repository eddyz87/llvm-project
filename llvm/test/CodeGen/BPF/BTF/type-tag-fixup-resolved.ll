...
entry:
  ...
  tail call void @llvm.dbg.declare(metadata ptr %v, metadata !11, metadata !DIExpression()), !dbg !28
...
declare !dbg !31 dso_local void @func(ptr noundef, ptr noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "some-file.c", directory: "/some/_dir", checksumkind: CSK_MD5, checksum: "8b3b8281c3b4240403467e0c9461251d")
