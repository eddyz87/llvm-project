...
!14 = distinct !DICompileUnit(language: DW_LANG_C11, file: !15, producer: "clang some version", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, retainedTypes: !16, splitDebugInlining: false, nameTableKind: None)
!15 = !DIFile(filename: "some-file.c", directory: "/some/dir")
!16 = !{!0}
...
; CHECK:        .long   [[#bravo:]]                     # BTF_KIND_STRUCT(id = 2)
; CHECK:        .long   [[#alpha:]]                     # BTF_KIND_STRUCT(id = 7)
; CHECK:        .long   [[#]]                           # BTF_KIND_TYPE_TAG(id = 8)
;
; CHECK:        .ascii  "bravo"                         # string offset=[[#bravo]]
; CHECK:        .ascii  "0:0"                           # string offset=[[#relo_spec:]]
; CHECK:        .ascii  "alpha"                         # string offset=[[#alpha]]
