...
// RUN:   -debug-info-kind=limited -S -emit-llvm -o - %s \
// RUN: | FileCheck --check-prefixes CHECK,CHECK-V1 %s
// RUN: %clang_cc1 \
// RUN:   -triple %itanium_abi_triple -debug-info-kind=limited \
...
// CHECK-V1: ![[L01]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: ![[L02:[0-9]+]], size: [[#]], annotations: ![[L03:[0-9]+]])
...
// CHECK-V1: ![[L13]] = !DIBasicType(name: "int", size: [[#]], encoding: DW_ATE_signed)
// CHECK-V1: ![[L11]] = !{![[L19:[0-9]+]], ![[L20:[0-9]+]]}
// CHECK-V1: ![[L19]] = !{!"btf_type_tag", !"tag1"}
// CHECK-V1: ![[L20]] = !{!"btf_type_tag", !"tag2"}
// CHECK-V1: ![[L07]] = !{![[L23:[0-9]+]], ![[L24:[0-9]+]]}
// CHECK-V1: ![[L23]] = !{!"btf_type_tag", !"tag3"}
// CHECK-V1: ![[L24]] = !{!"btf_type_tag", !"tag4"}
// CHECK-V1: ![[L03]] = !{![[L25:[0-9]+]], ![[L26:[0-9]+]]}
// CHECK-V1: ![[L25]] = !{!"btf_type_tag", !"tag5"}
// CHECK-V1: ![[L26]] = !{!"btf_type_tag", !"tag6"}
