...
// RUN:   -S -emit-llvm -o - %s | FileCheck %s --check-prefixes CHECK,CHECK-V1
// RUN: %clang_cc1 \
// RUN:   -triple %itanium_abi_triple -debug-info-kind=limited \
// RUN:   -mllvm -btf-type-tag-v2 -S -emit-llvm -o - %s | FileCheck %s --check-prefixes CHECK,CHECK-V2
...
// CHECK-V1: ![[L06]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: ![[L07:[0-9]+]], size: [[#]], annotations: ![[L08:[0-9]+]])
// CHECK-V1: ![[L07]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: ![[L01]], size: [[#]], annotations: ![[L10:[0-9]+]])
...
// CHECK:    ![[L10]] = !{![[L14:[0-9]+]]}
// CHECK-V1: ![[L14]] = !{!"btf_type_tag", !"tag1"}
// CHECK-V2: ![[L14]] = !{!"btf:type_tag", !"tag1"}
// CHECK:    ![[L08]] = !{![[L15:[0-9]+]]}
// CHECK-V1: ![[L15]] = !{!"btf_type_tag", !"tag2"}
...
// CHECK-V1: ![[L17]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: ![[L18:[0-9]+]], size: [[#]], annotations: ![[L19:[0-9]+]])
// CHECK-V1: ![[L18]] = !DIDerivedType(tag: DW_TAG_typedef, name: "__fn_t", file: ![[#]], line: [[#]], baseType: ![[L20:[0-9]+]])
